    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.preamble}>
          Se permite el ingreso a la pista de patinaje a niños a partir de los
          cinco (5) años de edad y a adultos.{"\n"}
          Es obligatorio que los niños entre 5 y 9 años ingresen a la pista
          acompañados por un adulto responsable.{"\n"}
          Los menores entre 10 y 15 años deberán ingresar bajo la supervisión de
          un adulto responsable presente en las instalaciones.{"\n"}
          Los jóvenes entre 16 y 17 años podrán suscribir el presente documento.
          {"\n"}
          <Text style={styles.boldText}>
            El tiempo máximo de permanencia dentro de la pista de patinaje será
            de una (1) hora por turno.
          </Text>
        </Text>

        <Text style={styles.legalText}>
          Declaro expresamente mi voluntad de participar en la actividad de
          patinaje sobre hielo en la pista instalada en dichas instalaciones de
          Peru On Ice y manifiesto mi conformidad y aceptación a lo que se señala
          a continuación tanto a nombre propio como de aquellas personas que
          están bajo mi custodia y/o respecto a los cuales soy padre y
          apoderado. En ese sentido:
        </Text>

        <Text style={styles.legalText}>
          Con la suscripción de la presente Declaración y en pleno uso de mis
          facultades manifiesto que{" "}
          <Text style={styles.boldText}>
            reconozco y acepto los riesgos inherentes a la actividad y asumo la
            responsabilidad derivada de mi participación
          </Text>
          , sin perjuicio de las obligaciones de seguridad que corresponden a la
          empresa.
        </Text>

        <Text style={styles.legalText}>
          PERU ON ICE con RUC 20613509446, sus agentes, representantes,
          propietarios, socios, accionistas, funcionarios, directores generales,
          afiliados, administradores, consejeros, colaboradores, auxiliares,
          usuarios, empleados, personal apoyo, voluntarios, fabricantes,
          participantes, arrendadores, subsidiarias, entidades relacionadas,
          franquiciantes, franquiciados, y todas aquellas personas o entidades
          que actúan con cualquier capacidad en su nombre o representación (todos
          en adelante y de manera conjunta &quot;POI&quot;), en mi nombre y en
          nombre de mis hijos o apoderados menores de edad de la siguiente
          manera:
        </Text>

        <Text style={styles.numberedItem}>
          <Text style={styles.boldText}>1.</Text> Reconozco y tengo pleno
          conocimiento y considerando que se me ha informado correcta, oportuna y
          de manera indubitable, que las actividades, juegos y la utilización de
          los juegos dentro de las instalaciones de POI implican la asunción de
          ciertos riesgos y peligros que existen y sobre los cuales se me ha
          informado claramente, que podrían resultar en lesiones físicas o
          emocionales, parálisis (total o parcial), muerte o daños a mi persona,
          a la propiedad o a terceros. Asimismo, reconozco expresamente que se me
          ha explicado que dichos riesgos y peligros no pueden ser eliminados, ya
          sea parcial o totalmente de dichas actividades, sin que se vea afectada
          la naturaleza de las mismas, las cuales estoy dispuesto(a) a realizar;
          asumiendo conscientemente el riesgo implícito en la realización de
          dichas actividades.
        </Text>

        <Text style={styles.numberedItem}>
          <Text style={styles.boldText}>2.</Text> Me obligo a cumplir las
          siguientes Reglas Generales del uso del servicio:
        </Text>
        ...
        <Text style={styles.numberedItem}>
          <Text style={styles.boldText}>3.</Text> Adicionalmente tengo pleno
          conocimiento que los riesgos inherentes a estas actividades incluyen,
          entre otros, señalados de manera enunciativa más no limitativa:{"\n"}
          a) Los participantes usualmente caen, sufriendo contusiones,
          distensiones, dislocaciones, cortadas, raspones, fricciones, quemaduras
          y/o hematomas, así como otras lesiones más serias, como esguinces,
          fracturas de muñecas, tobillos, piernas, o cualquier otra parte del
          cuerpo, lesiones en el cuello o en la cabeza, golpes en la región
          cráneo encefálica, parálisis o la muerte.{"\n"}
          b) Girar, voltear, correr, saltar en la pista de patinaje constituye
          una actividad peligrosa, que puede causar lesiones graves al
          participante y/o a otros participantes; por lo que de hacerlo, será
          bajo la estricta responsabilidad del participante.
        </Text>

        <Text style={styles.legalText}>
          En cualquiera de estas circunstancias, en el caso de que el
          participante o sus hijos menores de edad se lesionen y requieren
          asistencia médica, los gastos deberán ser asumidos por el participante
          o su representante legal,{" "}
          <Text style={styles.boldText}>
            salvo que se determine responsabilidad atribuible a la empresa
        ...
        <Text style={styles.numberedItem}>
          <Text style={styles.boldText}>4.</Text> Reconozco, tengo pleno
          conocimiento y acepto que los empleados de POI tienen una labor difícil
          de ejecutar y harán su mejor esfuerzo para proporcionar los más altos
          estándares de seguridad de todos los participantes. Sin embargo, los
          empleados no son infalibles. Está fuera del alcance de los empleados de
          POI tener conocimiento del estado de salud, condición médica y las
          habilidades de cada uno de los participantes. En consecuencia de manera
        ...
        <Text style={styles.signConformity}>
          ...
          que tuve oportunidad de leer su contenido completo; que lo entiendo;
          que comprendo sus alcances; que he sido informado correcta y
          oportunamente sobre los riesgos que se pueden presentar con mi
          participación en las actividades aquí descritas. En consecuencia, asumo
          con pleno conocimiento de causa la responsabilidad por todos los daños
          y perjuicios ocasionados por mí o por alguno(s) de mi(s) hijo(s)
          menor(es) de edad, de los que firmo como responsable frente a terceras
          personas, participantes, empleados de POI y/o de las instalaciones de
          POI para la cual responderé en lo personal; desligando, liberando de
          cualquier responsabilidad a POI y manteniendo indemne a POI en todo
          momento.
        </Text>

        <Text style={styles.closingText}>
          El participante se compromete a cumplir las normas de seguridad
          establecidas por la empresa y las instrucciones del personal encargado
          de la pista, con la finalidad de prevenir accidentes y garantizar la
          seguridad de todos los usuarios.
        </Text>

        <Text style={styles.imageAuth}>
          Por el presente documento yo autorizo a Perú On Ice, con RUC
          20613509446 y con domicilio en La Rosa Toro 1250, distrito de San
          Borja (Lima) a utilizar las imágenes de las que son parte yo y mis
          familiares y que se registraron en las fotos y/o videos efectuados el
        ...
        >
          Leída en su totalidad la presente declaración, y enterado(a) con su
          contenido y alcances legales, la firmo en señal de conformidad.
        </Text>
